...
export default {
    ...
    methods: {
        calculate: function() {
            ...
            // [
            // 22.50086425,309.0873674,387.1314028,219.0372444,2221.971078,6568.841545,2221.945277,2221.651326,11.6113845,
            // 10.75227419,960.5593774,814.9404083,400.8460544,9000.045491,8034.867892,9000.002745,8999.960343,20.9722689,
            // 4.70804269,105.495923,120.8633678,75.17604336,26.85769521,31.61925198,26.8250078,26.59346447,1.37673974,
            // 32400000,58800000,20000000,2400000,2580000,2400000,2400000,31.5676,
            // 450658.9942,2.06E+14,329999.9973,19114.18582,330000.0026,330000.0082,17100000000,1330.983123,394.6209516,34000000,7350000,34000000,34000000,12400000,18000.00134,203000000,18000.00224,18000.00143,2120000000,
            // 16.38783403,41.58091535,43.24757759,41.61774522,63.24304966,46.87023721,39.3362073,42.67290199,18.93567048,
            // 12.326433156,47.6270149,47.40452008,49.73176153,57.972794,62.06013493,54.23705297,84.31289581,24.24203655,
            // 20.30761572,46.25438969,46.65748479,45.72198561,36.27343106,36.7025734,36.39260826,36.29917096,15.327459819,
            // 129.9123464,131.5916016,125.3924032,127.1569463,127.4479459,127.6135086,129.0121508,35.0008564,
            // 107.5808518,209.9419822,94.5720381,68.08019766,86.7547876,110.2861527,153.325739,59.94546278,46.69479381,148.7407064,101.9267229,149.4051483,150.4436438,115.5183132,100.7188347,130.8507,100.9040376,101.4525465,158.1303922,0.00000005,0.00000004,0.00000002]
            ...
            23.586398565694623, 39.73374888348373, 40.157863678221304, 42.39088938660048, 70.06473772340762, 66.51029829383914, 56.69822688135666, 59.098657219517804, 26.866264610945063,
            18.425019043327264, 41.81540149488168, 46.19250009177392, 47.76096926092399, 82.28083877592063, 76.70377120839291, 79.09684199969037, 87.15011901063443, 33.82299223091391,
            20.16520290867562, 38.02115268163156, 37.43262273968059, 40.01259337439773, 34.95391065613341, 28.573720574564327, 28.273186878061516, 29.642492805649955, 9.219997038150703,
            141.44472198221058, 142.99066634196635, 137.81308903678558, 128.8707890496875, 129.92824522753747, 129.49075358359326, 132.0114679378595, 38.09561096298383,
            107.3879503967382, 250.1688100874581, 105.26419283190545, 67.80967641649626, 90.58110359610984, 113.53748716314338, 174.56316836484393, 61.562807472008586, 43.75430393417363, 147.95327006326931, 126.52031166082853, 149.6575323749135, 152.0099933276576, 126.51036942373399, 100.46887062858448, 148.83535626060683, 100.96576698756049, 102.19837048176268, 161.06844761261735
            ...
            var iterator = 0
            var MAX_ITERATOR = 100
            var i

            try {
                for (i = 0; i < MAX_ITERATOR; i++) {
                    bfgs.step()
                    console.log(bfgs.fMin)
